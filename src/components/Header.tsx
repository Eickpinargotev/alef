...
import { ShoppingCart, Menu, X, Instagram, Phone } from 'lucide-react'; // Phone for WhatsApp roughly
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <a href="/" className="text-3xl font-bold text-lilac-900 font-serif tracking-tight">
                            ALEF
                        </a>
                    </div>
